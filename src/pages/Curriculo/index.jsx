    ...
    return(
        <>
            <div className="background background_h1 border border-secondary">
                <h1 className="rounded-pill col-md-5 text-center margin">Currículo</h1>
            </div>
            <div className="background_column row w-100">            
                ...
                <div className="container col col-md-3 border border-secondary rounded bordas border-2">
                    ...
                    <p>Empresa aonde dia após dia venho aprendendo cada vez mais e mais e evoluindo, aprendi muito até agora em relação a noções de empresa grande, 
                    e como funciona sistemas de ambientes de PRD de QAS e de DEV. e continua me ensinando muito.</p>
                </div>
            </div>
            <div className="background curriculo_margin">
                <div className="container bordas margin"> 
                    <div className="container col col-md-8 border border-secondary rounded bordas border-2 background curriculo">
                        ...
                        evoluindo cada dai mais pessoalmente e socialmente, sou empenhado e sou de difícil desistência, 
                        tenho aciduidade em relação a horários e foco para resolver problemas.</p>
                    </div>
                </div>
            </div>
        </>
